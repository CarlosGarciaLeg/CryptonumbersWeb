                ...
                <v-row class="  mt-2 justify-center" style="width:100%; ">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span
                          class="tituloPortada__sub--description  ma-4"
                          v-html="description"
                        >
                        </span>
                      </v-col>
      ...
      infoTokens: [
        {
          textoTokens: [
            "General ",
            "Inversores iniciales y advisors ",
            "Fundadores",
            "Reserva de compensación",
          ],
          color: ["#248ef9", "#bd85ff", "#66b0e1", "#1b23b4"],
        },
      ],
    };
  },
